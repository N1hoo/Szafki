...
class Ui_DodajSzafki(object):
    def setupUi(self, DodajSzafki):
        ...
        DodajSzafki.resize(652, 111)
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=DodajSzafki)
        self.buttonBox.setGeometry(QtCore.QRect(590, 70, 51, 31))
        ...
        self.label_11.setGeometry(QtCore.QRect(560, 10, 64, 16))
