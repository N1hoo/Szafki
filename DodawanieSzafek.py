...
class Ui_DodajSzafki(object):
    def setupUi(self, DodajSzafki):
        ...
        DodajSzafki.resize(582, 136)
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=DodajSzafki)
        self.buttonBox.setGeometry(QtCore.QRect(530, 90, 51, 31))
        ...
        self.MiejsceDS.setGeometry(QtCore.QRect(10, 40, 151, 31))
        self.MiejsceDS.setAccessibleName("")
        self.MiejsceDS.setEditable(True)
        self.MiejsceDS.setObjectName("MiejsceDS")
        self.TypDS = QtWidgets.QComboBox(parent=DodajSzafki)
        self.TypDS.setGeometry(QtCore.QRect(170, 40, 81, 31))
        self.TypDS.setEditable(False)
        self.TypDS.setObjectName("TypDS")
        self.NrSzDS = QtWidgets.QLineEdit(parent=DodajSzafki)
        self.NrSzDS.setGeometry(QtCore.QRect(330, 40, 71, 31))
        self.NrSzDS.setMaxLength(3)
        self.NrSzDS.setObjectName("NrSzDS")
        self.KodZDS = QtWidgets.QLineEdit(parent=DodajSzafki)
        self.KodZDS.setGeometry(QtCore.QRect(410, 40, 71, 31))
        ...
        self.label_8.setGeometry(QtCore.QRect(330, 20, 45, 16))
        self.label_8.setWordWrap(True)
        self.label_8.setObjectName("label_8")
        self.label_7 = QtWidgets.QLabel(parent=DodajSzafki)
        self.label_7.setGeometry(QtCore.QRect(170, 20, 18, 16))
        self.label_7.setObjectName("label_7")
        self.label_9 = QtWidgets.QLabel(parent=DodajSzafki)
        self.label_9.setGeometry(QtCore.QRect(410, 20, 58, 16))
        self.label_9.setWordWrap(True)
        self.label_9.setObjectName("label_9")
        self.PlecDS = QtWidgets.QComboBox(parent=DodajSzafki)
        self.PlecDS.setGeometry(QtCore.QRect(260, 40, 61, 31))
        self.PlecDS.setEditable(False)
        self.PlecDS.setObjectName("PlecDS")
        self.label_10 = QtWidgets.QLabel(parent=DodajSzafki)
        self.label_10.setGeometry(QtCore.QRect(260, 0, 71, 41))
        self.label_10.setWordWrap(True)
        self.label_10.setObjectName("label_10")
        self.DodajBtDS = QtWidgets.QPushButton(parent=DodajSzafki)
        self.DodajBtDS.setGeometry(QtCore.QRect(450, 90, 75, 31))
        self.DodajBtDS.setObjectName("DodajBtDS")
        self.StatusSzDS = QtWidgets.QComboBox(parent=DodajSzafki)
        self.StatusSzDS.setGeometry(QtCore.QRect(490, 40, 81, 31))
        ...
        self.label_11.setGeometry(QtCore.QRect(490, 20, 64, 16))
    ...
    def retranslateUi(self, DodajSzafki):
        ...
        self.TypDS.setWhatsThis(_translate("DodajSzafki", "Typ dodawanych szafek"))
        ...
        self.label_7.setText(_translate("DodajSzafki", "Typ"))
