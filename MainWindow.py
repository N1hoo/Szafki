...
class OknoGlowne(QMainWindow, Ui_MainWindow):
    ...
    def on_przydziel_szafke_pracownikowi(self):
        ...
        if wiersz >= 0: 
            ...
            # Jeśli PlecDP to np. QComboBox – można zrobić ui.PlecDP.setCurrentText(plec)
            ui.PlecDP.setText(plec)        # lub setCurrentText, zależnie od widgetu
            ui.DzialDP.setText(dzial)      # lub setCurrentText
